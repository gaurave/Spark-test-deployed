...
class SparkPolymerUI extends SparkWidget with ChangeNotifier  {
  ...
  @reflectable @observable bool get useAceThemes => __$useAceThemes; bool __$useAceThemes = true; @reflectable set useAceThemes(bool value) { __$useAceThemes = notifyPropertyChange(#useAceThemes, __$useAceThemes, value); }
  @reflectable @observable bool get showWipProjectTemplates => __$showWipProjectTemplates; bool __$showWipProjectTemplates = true; @reflectable set showWipProjectTemplates(bool value) { __$showWipProjectTemplates = notifyPropertyChange(#showWipProjectTemplates, __$showWipProjectTemplates, value); }
  ...
  @reflectable @observable bool get showNoFileFilterMatches => __$showNoFileFilterMatches; bool __$showNoFileFilterMatches = false; @reflectable set showNoFileFilterMatches(bool value) { __$showNoFileFilterMatches = notifyPropertyChange(#showNoFileFilterMatches, __$showNoFileFilterMatches, value); }
